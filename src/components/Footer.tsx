    ...
    <footer className="bg-lady-accent py-8 border-t">
      <div className="container px-2 md:px-6">
        <div className="grid gap-8 sm:grid-cols-2">
          <div className="grid grid-cols-[auto_auto] sm:block">
              <img
                alt="여성 대리운전"
                className="h-8 sm:h-10 w-fit sm:mb-4"
                src="/logo_white.png"
              />
            <ul className="text-sm text-white pl-8">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  카카오 채널: <a href="https://pf.kakao.com/_xnxkxfin" target="_blank" rel="noopener noreferrer" className="text-white font-semibold hover:underline">언니차</a>
                </span>
              </li>
            </ul>
          </div>
