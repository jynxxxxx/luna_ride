  ...
  const faqs = [
    {
      ...
      answer: '모든 기사님은 신원 확인 및 사전 검증을 마친 분들로, 서비스 품질과 안전을 위해 내부 교육을 수료하신 분들만 활동합니다. 여성 고객의 안심 귀가를 최우선으로 생각합니다.',
    },
    {
      question: '예약은 어떻게 진행되나요?',
      answer: '웹사이트 예약 폼 또는 카카오톡 채널을 통해 예약하실 수 있습니다. 원하는 날짜와 시간, 출발지와 도착지를 입력하시면 확인 후 매칭 안내를 드립니다.',
    },
    {
      question: '이용 가격은 얼마인가요?',
      answer: '기본 요금은 거리와 시간대에 따라 달라지며, 예약 시 예상 요금을 안내해드립니다. 최종 요금은 도착 후 현장에서 결제하시면 됩니다.',
    },
    {
      question: '시간 변경이나 예약 취소는 어디서 하나요?',
      answer: '예약 확인 메시지에 있는 링크를 통해 시간 변경이나 취소가 가능합니다. 이용 2시간 전까지 무료로 변경 및 취소가 가능하며, 이후에는 수수료가 발생할 수 있습니다.',
    },
    {
      question: '기터 문의는 어디에서 가능한가요?',
      answer: '카카오톡 채널 또는 웹사이트 내 문의하기를 통해 언제든지 연락주시면 신속히 답변드리겠습니다.',
    },
  ]
